              ...
              <div className="p-8 bg-white/50 backdrop-blur-sm rounded-2xl border border-gray-200 hover:bg-white/60 transition-all hover:shadow-xl">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[15px] text-gray-700 leading-relaxed">
                      Your data never leaves our secure infrastructure. We don't use external analytics, tracking, or advertising networks. What you investigate stays between you and Deal Shield.
                    </p>
                  </div>
                </div>
              </div>
