...
import POFUploadForm from './POFUploadForm'

export default async function POFVerificationPage() {
  ...
  // Fetch user's POF verifications
  const { data: verifications } = await supabase
    .from('document_verifications')
    .select('*')
    .eq('user_id', user.id)
    .eq('document_type', 'POF')
      ...
      <main className="relative">
        ...
        <div className="relative max-w-[1400px] mx-auto px-8 pt-32 pb-16">
          ...
          <div className="flex items-center gap-2 text-[14px] text-gray-600 mb-6">
            ...
            <span>→</span>
            <span className="text-gray-900 font-medium">Proof of Funds</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-[18px] text-gray-600 leading-relaxed">
              Upload POF documents to verify financial capacity, detect fraud, and get AI-powered insights
            </p>
          </div>
          ...
          <div className="mb-12 p-8 rounded-xl bg-white border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex flex-col items-start">
                ...
                <div className="text-[16px] font-semibold text-gray-900 mb-2">Bank Verification</div>
                <div className="text-[14px] text-gray-600 leading-relaxed">Verify authenticity of bank and financial institution</div>
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="text-[16px] font-semibold text-gray-900 mb-2">Financial Capacity</div>
                <div className="text-[14px] text-gray-600 leading-relaxed">Confirm sufficient funds for stated transaction amount</div>
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="text-[16px] font-semibold text-gray-900 mb-2">Document Authenticity</div>
                <div className="text-[14px] text-gray-600 leading-relaxed">Detect alterations, forgery, and fake documents</div>
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="text-[14px] text-gray-600 leading-relaxed">Identify common scam patterns and red flags</div>
              </div>
            </div>
          </div>
          ...
          {/* Upload Form */}
          <div className="mb-12">
            <POFUploadForm userId={user.id} />
          </div>

          {/* Recent Verifications */}
          {recentVerifications.length > 0 && (
            <div>
              <h2 className="text-[28px] font-bold text-gray-900 mb-6 tracking-[-0.01em]">Recent POF verifications</h2>
              <div className="space-y-3">
                {recentVerifications.map((verification) => (
                  <Link
                    key={verification.id}
                    href={`/verify/pof/${verification.id}`}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="text-[15px] font-semibold text-gray-900 group-hover:text-[#635BFF] transition">
                            {verification.document_name || 'POF Document'}
                          </div>
