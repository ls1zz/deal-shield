...
export default async function LOIVerificationPage() {
  ...
  // Fetch user's LOI verifications
      ...
      <main className="relative">
        ...
        <div className="relative max-w-[1400px] mx-auto px-8 pt-32 pb-16">
          ...
          <div className="flex items-center gap-2 text-[14px] text-gray-600 mb-6">
            ...
            <span>→</span>
            <span className="text-gray-900 font-medium">Letter of Intent</span>
          </div>

          {/* Page Title */}
          <div className="mb-8">
            <h1 className="text-[48px] font-bold text-gray-900 tracking-[-0.02em] leading-tight mb-3">
              Verify Letter of Intent
            </h1>
            <p className="text-[18px] text-gray-600 leading-relaxed">
              Upload LOI documents to verify parties, detect fraud, and get AI-powered insights
            </p>
          </div>
          ...
          <div className="mb-12 p-8 rounded-xl bg-white border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex flex-col items-start">
                ...
                <div className="text-[14px] text-gray-600 leading-relaxed">Verify buyer & seller identity and business registration</div>
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="text-[14px] text-gray-600 leading-relaxed">Check if parties have capacity for stated transaction value</div>
              </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="text-[16px] font-semibold text-gray-900 mb-2">Document Analysis</div>
                <div className="text-[14px] text-gray-600 leading-relaxed">Detect inconsistencies, missing clauses, and red flags</div>
              </div>
          ...
          {/* Upload Form */}
          <div className="mb-12">
            <LOIUploadForm userId={user.id} />
          </div>

          {/* Recent Verifications */}
          {recentVerifications.length > 0 && (
            <div>
              <h2 className="text-[28px] font-bold text-gray-900 mb-6 tracking-[-0.01em]">Recent LOI verifications</h2>
              <div className="space-y-3">
                {recentVerifications.map((verification) => (
                  <Link
                    key={verification.id}
                    href={`/verify/loi/${verification.id}`}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="text-[15px] font-semibold text-gray-900 group-hover:text-[#635BFF] transition">
                            {verification.document_name || 'LOI Document'}
                          </div>
