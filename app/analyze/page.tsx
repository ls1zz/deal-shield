...
export default function AnalyzePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult(data)
      setStep('results')
      setLoading(false) // Auto-dismiss modal on success
  ...
  const renderFormFields = () => {
    ...
    return (
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Transaction Details</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#635BFF] focus:border-transparent"
              />
            </div>
            <div>
        ...
        {/* Seller Information */}
        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Seller Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
        ...
        {/* Buyer Information */}
        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Buyer Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
        ...
        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Intermediary/Broker Information <span className="text-sm text-gray-500 font-normal">(Optional)</span></h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
        ...
        {category === 'automotive' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Vehicle Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        {category === 'aviation' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Aircraft Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        {category === 'fine_art' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Artwork Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        {category === 'bullion' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Bullion Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        {category === 'cryptocurrency' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Cryptocurrency Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        {category === 'luxury_watches' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Watch Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        {category === 'wine_spirits' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Wine & Spirits Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        {category === 'gemstones' && (
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Gemstone Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
        ...
        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-100/50 shadow-inner">
          ...
          <textarea
            ...
            className="w-full h-28 sm:h-32 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#635BFF] focus:border-transparent resize-none"
          />
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <main className="relative pt-[64px] sm:pt-[72px]">
        ...
        <div className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className={`mb-4 sm:mb-6 p-3 sm:p-4 rounded-lg border ${
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                {(isLowOnReports || isOutOfReports) && (
                  <Link
                    href="/pricing"
                    className={`px-4 py-2 rounded-lg font-medium transition text-sm text-center ${
                      isOutOfReports
          ...
          {step === 'category' && (
            <div className="bg-white/50 backdrop-blur-sm rounded-lg border border-purple-100/50 shadow-inner p-4 sm:p-6">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Select Asset Category</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                {categories.map((cat) => (
                  <button
                    ...
                    className="p-3 sm:p-4 bg-white/50 backdrop-blur-sm border-2 border-purple-100/50 rounded-lg hover:border-[#635BFF] hover:shadow-xl transition text-left disabled:opacity-50 disabled:cursor-not-allowed shadow-inner hover:scale-105"
                  >
          ...
          {step === 'form' && (
            <div className="bg-white/50 backdrop-blur-sm rounded-lg border border-purple-100/50 shadow-inner p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Due Diligence Form</h2>
                ...
                <button
                  ...
                  className="text-xs sm:text-sm text-gray-600 hover:text-gray-900 font-medium text-left sm:text-right"
                >
                  Change Category
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-4 sm:mt-6 flex flex-col-reverse sm:flex-row items-center justify-between gap-3 pt-4 sm:pt-6 border-t border-gray-200">
                  <button
                    type="button"
                    onClick={() => setStep('category')}
                    className="text-xs sm:text-sm text-gray-600 hover:text-gray-900 font-medium w-full sm:w-auto text-center"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className="w-full sm:w-auto px-5 sm:px-6 py-2 sm:py-2.5 bg-[#635BFF] text-white rounded-lg hover:bg-[#5349E6] transition font-medium disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
                    {isOutOfReports ? 'Upgrade Required' : 'Start Investigation'}
                  </button>
                </div>
              </form>
            </div>
          ...
          {step === 'results' && result && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-white/50 backdrop-blur-sm rounded-lg border border-purple-100/50 shadow-inner p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Investigation Complete</h2>
                  <button
                    onClick={handleNewInvestigation}
                    className="w-full sm:w-auto px-4 py-2 text-[#635BFF] hover:bg-gray-50 rounded-lg transition font-medium border border-[#635BFF] text-sm"
                  >
                    New Investigation
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                  ...
                  <div className="text-center">
                    <div className="inline-flex items-center justify-center w-28 h-28 sm:w-32 sm:h-32 rounded-full border-4 border-gray-200 bg-gray-50">
                      <div className="text-3xl sm:text-4xl font-bold text-gray-900">{result.risk_score}</div>
                    </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">{result.executive_summary}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white/50 backdrop-blur-sm rounded-lg border border-purple-100/50 shadow-inner p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-3 gap-3 sm:gap-4">
                    <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="text-2xl sm:text-3xl font-bold text-[#635BFF]">{result.verification_status.companies_checked}</div>
                      <div className="text-[10px] sm:text-xs text-gray-600 mt-1 sm:mt-2">Companies Checked</div>
                    </div>
                    <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="text-2xl sm:text-3xl font-bold text-[#635BFF]">{result.verification_status.individuals_checked}</div>
                      <div className="text-[10px] sm:text-xs text-gray-600 mt-1 sm:mt-2">Individuals Checked</div>
                    </div>
                    <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="text-2xl sm:text-3xl font-bold text-[#635BFF]">{result.verification_status.assets_verified}</div>
                      <div className="text-[10px] sm:text-xs text-gray-600 mt-1 sm:mt-2">Assets Verified</div>
                    </div>
                  </div>
                </div>
              )}
              ...
              {result.red_flags && result.red_flags.length > 0 && (
                <div className="bg-white/50 backdrop-blur-sm rounded-lg border border-purple-100/50 shadow-inner p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Red Flags Identified</h3>
                  <div className="space-y-2 sm:space-y-3">
                    {result.red_flags.map((flag: any, index: number) => (
                      <div key={index} className={`p-3 sm:p-4 rounded-lg border-l-4 ${
                        ...
                        <p className="font-medium text-gray-900 mb-1 text-xs sm:text-sm">{flag.description}</p>
                        <p className="text-xs sm:text-sm text-gray-600">Evidence: {flag.evidence}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {result.party_backgrounds && result.party_backgrounds.length > 0 && (
                <div className="bg-white/50 backdrop-blur-sm rounded-lg border border-purple-100/50 shadow-inner p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Party Backgrounds</h3>
                    ...
                    {result.party_backgrounds.map((party: any, index: number) => (
                      <div key={index} className="p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                          <h4 className="font-semibold text-gray-900 text-sm sm:text-base">{party.name}</h4>
                          <span className="inline-block w-fit px-2 py-1 bg-[#635BFF] text-white text-[10px] sm:text-xs rounded font-medium">
                            {party.type} • {party.country}
                          </span>
                        </div>
                        <p className="text-xs sm:text-sm text-gray-700 mb-2">{party.findings}</p>
              ...
              <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 bg-white text-gray-700 rounded-lg hover:bg-gray-50 transition font-medium border border-gray-300 text-xs sm:text-sm"
                >
                  Export PDF
                </button>
              </div>
              ...
              <>
                ...
                <div className="mb-6">
                  <div className="relative w-24 h-24 mx-auto">
                    {/* Outer ring */}
                    <div className="absolute inset-0 border-4 border-[#635BFF]/20 rounded-full"></div>
                    {/* Animated ring */}
                    <div className="absolute inset-0 border-4 border-transparent border-t-[#635BFF] rounded-full animate-spin"></div>
                    {/* Inner pulse */}
                    <div className="absolute inset-3 bg-[#635BFF]/10 rounded-full animate-pulse"></div>
                    {/* Center icon */}
                ...
                <p className="text-base text-gray-600 mb-2">
                  Analyzing transaction and parties...
                </p>
                <p className="text-sm text-gray-500 mb-6">
                  Don't close this page. This could take 2-10 minutes
                </p>
